...
##
## Debug
ProjectName            :=blink-pcf
ConfigurationName      :=Debug
WorkspacePath          :=/home/maxime/tp-poo-2.0
ProjectPath            :=/home/maxime/tp-poo-2.0/blink-pcf
...
ObjectsFileList        :="blink-pcf.txt"
PCHCompileFlags        :=
MakeDirCommand         :=mkdir -p
LinkOptions            := $(shell pkg-config --libs piduino) 
...
CXX      := g++
CC       := gcc
CXXFLAGS := -std=c++14 $(shell pkg-config --cflags piduino) -g -O0 -Wall $(Preprocessors)
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp $(IntermediateDirectory)/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/maxime/tp-poo-2.0/blink-pcf/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
